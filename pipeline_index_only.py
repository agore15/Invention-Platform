...
def run_pipeline():
    print('=== Starting 3GPP Indexer Only ===')

    # 1. Crawler (SKIPPED)
    print('\n[Phase 1] Crawler Skipped. Using existing data.')
    ...
    print(f'Found {len(files)} specification files: {[os.path.basename(f) for f in files]}')
    ...
    for file_path in files:
        ...
        try:
            ...
            # FIX: Replace literal backslash-n with real newline
            text = text.replace('\\n', '\n')
